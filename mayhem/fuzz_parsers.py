...
def TestOneInput(data):
    ...
    try:
        ...
        # Expected library/stdlib exceptions on adversarial input — not defects. Anything
        # else (a genuine bug in ofxstatement) still propagates and crashes the harness.
        return -1
