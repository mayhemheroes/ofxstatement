...
#endif
#ifndef HARNESS
#define HARNESS "/mayhem/mayhem/fuzz_reader.py"
#endif
/* PYPATH is baked in at compile time so the harness imports (atheris, ofxstatement)
 * resolve even when the launcher is invoked with a scrubbed environment (Mayhem's
 * coverage-collection subprocesses don't inherit the image ENV). */
#ifndef PYPATH
#define PYPATH ""
#endif
